...
<link rel="stylesheet" href="https://codeigniter4-datatables.hermawan.dev/assets/css/theme.css" />
    ...
    <header>
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="<?= base_url().'warehouses' ?>">Warehouses</a></li>
                ...
                <li class="menu-item hidden"><a href="<?= base_url().'product-details' ?>">Product Details</a></li>
